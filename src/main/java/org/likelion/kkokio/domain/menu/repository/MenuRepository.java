...
public interface MenuRepository extends JpaRepository<Menu, Long> {
    ...
    @Query("SELECT m, c, s FROM Menu m JOIN m.category c JOIN c.store s JOIN s.adminAccount a " +
    ...
    @Query("SELECT m, s, c FROM Menu m JOIN m.category c JOIN c.store s JOIN s.adminAccount a " +
